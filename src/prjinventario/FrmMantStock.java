...
public class FrmMantStock extends javax.swing.JFrame {
    ...
    public void JasperReport()
    {
        ...
        String script = "select * from stock";
        
        try
        {
            //Lista para guardar elementos
            List<DatosStock> lista = new ArrayList<DatosStock>();
            ...
            while(resultado.next())
            {
                DatosStock datos = new DatosStock();
                
                datos.setCodigo(Integer.parseInt(resultado.getString(1)));
                datos.setNombre(resultado.getString(2));
                datos.setCantidad(Integer.parseInt(resultado.getString(3)));
                datos.setPrecio(Double.parseDouble(resultado.getString(4)));
                datos.setAlmacen(resultado.getString(5));
            ...
            InputStream archivo = new FileInputStream(new File("C:\\Users\\kinglion\\Desktop\\JasperReport\\JRXML\\Stock.jrxml"));
